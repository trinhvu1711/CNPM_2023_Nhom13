...
<div class="hero-wrap hero-bread" style="background-image: url('https://th.bing.com/th/id/R.9798d980fa39c84daa692261ebe7cd29?rik=2k4N7YxmBY%2b9VA&pid=ImgRaw&r=0');">
        ...
        <div class="row block-9">
            <div class="col-md-6 order-md-last d-flex">
                <form action="/BHNFoods/ContactInUser" method="post" class="bg-white p-5 contact-form">
                    <h3 style="color: #01d28e">Gửi phản hồi cho chúng tôi</h3>
                    <div class="form-group" style="display: none">
                        <input name="iduser" type="text" class="form-control" placeholder="Họ và tên"
                               value="">
                    </div>
                    <div class="form-group">
                        <input name="nameuser" type="text" class="form-control" placeholder="Họ và tên" value="">
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-6 d-flex instruct">
                <div>
                   ...
                   - Có nhu cầu được giao Sản phẩm đến các địa điểm phù hợp với Chính sách giao hàng đăng tải trên Website.<br></span>
                    ...
                    <span class="text-dark" style="font-size: 17px">Mọi thông tin về Sản Phẩm đưa ra trên BHNFoods trong bất kỳ trường hợp nào không được hiểu là đề nghị giao kết hợp đồng của Winmart tới Khách Hàng.
